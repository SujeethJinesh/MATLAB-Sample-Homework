%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Name         : Sujeeth Jinesh
% T-square ID  : sjinesh3
% GT Email     : sjinesh3@gatech.edu
% Homework     : 3
% Course       : CS1371
% Section      : HP4
% Collaboration: 
%                 "I worked on this homework with Nina Patronis, Soham
%                 Gadgil, Utkarsh Pandey, Avery Yang, Ying Ying Choi
%                 and referred to Matlab Documentation"
%
%
